...
def create_ui():
    ...
    #chatbot {
        flex: 1 1 auto; /* Let chatbot grow and shrink */
        overflow-y: auto;
        min-height: 65vh;
    }
    #controls-container {
    ...
    """) as demo:
        ...
        with gr.Column(elem_id="controls-container", scale=0) as controls_container:
            # Row for Yes/No feedback buttons
            ...
            # Column for the "No" path's detailed feedback form
            with gr.Column(visible=False) as feedback_controls_col:
                feedback_textbox = gr.Textbox(
                    label="What would you like to improve?",
                    placeholder="E.g., Add a filter for last February only...",
                    lines=2,
                )
        ...
        elements = {
            ...
            "feedback_controls_col": feedback_controls_col,
